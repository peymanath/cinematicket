...
import { HeaderAccountButtonProps } from '@/Types/Common';

const HeaderAccountButton: React.FC<HeaderAccountButtonProps> = ({ role }) => {
  ...
  console.log(data)
  const menuItem = role === Role.USER ? userMenuItem : adminLoggedIn;
  return isLoading ? (
